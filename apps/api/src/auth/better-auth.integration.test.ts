...
const environment: ApiEnvironment = {
  ...
  GAME_SERVER_INSTANCE_ID: 'game-server-test',
  GAME_SERVER_INTERNAL_SECRET: 'internal-integration-secret'.padEnd(32, '0'),
  ...
  MULTIPLAYER_RATE_LIMIT_WINDOW_SECONDS: 60,
  MULTIPLAYER_TICKET_SECRET: 'ticket-integration-secret'.padEnd(32, '0'),
  NODE_ENV: 'test',
